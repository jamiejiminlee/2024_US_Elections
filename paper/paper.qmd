...
\[
y_i|\mu_i, \sigma \sim \mbox{Bernoulli}(\mu_i)
\]
\[
...
# Check that state_average has the correct number of rows and no grouping
print(nrow(state_average))  # Ensure this number matches the expected rows
