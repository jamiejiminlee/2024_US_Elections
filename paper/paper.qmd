...
The predictive model forecasts Donald Trump as the likely winner of the 2024 U.S. Presidential Election. By analyzing state-level polling data through a Bayesian logistic regression model, the study estimates the probability of Trump or Kamala Harris winning in each state. The model identifies a significant geographic split in voter support: Trump is expected to dominate in southern and midwestern states, where his polling percentages consistently surpass those of Harris. Key states projected to favor Trump include Florida, Georgia, and Ohio, which are pivotal in securing an Electoral College majority. Harris, on the other hand, holds stronger polling percentages in East Coast states and parts of the Midwest, yet these leads appear insufficient to overcome Trump’s advantage across the broader landscape of competitive states.

In particular, battleground states show varied support but lean overall toward Trump, reflecting his edge in areas like Arizona, Nevada, and North Carolina. By aggregating high-quality polls filtered for transparency and reliability, the model underscores Trump’s stable base in regions that carry substantial electoral weight. The predictions suggest that while Harris may perform well in several Democratic strongholds, Trump’s consistent support across critical swing states positions him as the probable victor in the upcoming election.
